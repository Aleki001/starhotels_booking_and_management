package com.alexkinyua.StarHotels.utils;

import com.alexkinyua.StarHotels.dto.BookingDto;
...
public class Utils {
    ...
    public static List<RoomDto> mapUserRoomEntityToRoomListDto(List<Room> roomList){
